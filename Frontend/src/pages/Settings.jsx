    ...
    <DashboardLayout>
      ...
      <div className="rounded-2xl bg-card border border-border p-6! max-w-md">
        <div className="flex items-center gap-4 pb-5! mb-5! border-b border-border">
          <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-r from-gradFrom to-gradTo text-white font-semibold">
        ...
        <button
          onClick={afterLogout}
          className="w-full flex items-center justify-center gap-2 mt-6! py-2.5! rounded-lg font-medium text-white bg-red-500/90 hover:bg-red-500 transition"
        >
          <LogOut size={16} />
          Log out
        </button>
